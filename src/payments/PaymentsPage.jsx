	...
	return (
		<Modal
			...
			<Form form={form} layout='vertical' onFinish={mutate} className='pt-2'>
				...
				<Form.Item name='category' label='Category' initialValue='sale' rules={[{ required: true }]}>
				...
				<div className='flex items-center gap-3 flex-wrap'>
					<div className='relative max-w-md flex-1 min-w-[240px]'>
						...
						<input
							...
							placeholder='Search entries by meaning, e.g. "payroll expenses"'
						...
						<table className='w-full text-sm'>
							<thead>
								<tr style={{ background: 'var(--color-surface)', borderBottom: '1px solid var(--color-border)' }}>
									{['Date', 'Category', 'Type', 'Method', 'Amount', 'Notes'].map((col) => (
